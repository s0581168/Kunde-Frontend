<template>
  <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#kunde-create-offcanvas" aria-controls="#kunde-create-offcanvas">Update</button>
  <div class="offcanvas offcanvas-end" tabindex="-1" id="kunde-create-offcanvas" aria-labelledby="offcanvas-label">
    ...
    <div class="offcanvas-body">
      <form class="text-start needs-validation" id="kunde-create" novalidate>
        ...
        <div class="mt-5">
          <button class="btn btn-primary me-3" type="submit" @click.prevent="createKunde(k.id)">Update</button>
...
export default {
  ...
  emits: ['created'],
  methods: {
    async createKunde (kundeId) {
      const valid = this.validate()
      if (valid) {
        const endpoint = process.env.VUE_APP_BACKEND_BASE_URL + '/api/v1/kunde_verwaltung/' + kundeId
